...
const Item = props => {
    ...
    return (
        <div className="Mag-Table-Item">
            <p className="Mag-Table-Item_id">{props.id}</p>
            <p>vcxhsdvc</p>
            <p>Mike22</p>
            <p>5665cddced</p>
            <p><img className='Mag-Table-Item-Logo' src={logo} alt="" /></p>
            <p></p>
            <p></p>
            ...
            <div onClick={handleDropDown}>
                ...
                {isDropDown && <ActionDropDwon isMag={true} />}
            </div>
        </div>
    )
}
